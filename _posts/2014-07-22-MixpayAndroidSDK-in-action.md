实战：使用 MixpayAndroidSDK快速集成移动支付功能
==============================================

# 一、MixpayAndroidSDK简介

MixpayAndroidSDK的目标就是使开发者很轻松地在自己的APP中集成支付功能，从而节约时间和精力用在本身的业务当中。
...
* 支付平台技术支持不足，联调困难
* 每一个支付通道都要折腾一翻MixpayAndroidSDK致力于帮助开发者解决以上问题。

以下通过一个实际项目来说明如何使用MixpayAndroidSDK。笔者的开发环境：
